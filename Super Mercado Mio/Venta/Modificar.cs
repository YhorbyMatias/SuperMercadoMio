...
namespace Super_Mercado_Mio.Venta
{
    public partial class Modificar : Form
    {
        ...
        List<DetalleDeEgresoEnt> invoiceLinesDeleted = new List<DetalleDeEgresoEnt>();
        ...
        private void Modificar_Load(object sender, EventArgs e)
        {
            ...
            if (objetoAperturaDeCaja.exists(aperturaDeCaja) > 0)
            {
                ...
                //Cargar datos del formulario y monto original
        ...
        private void searchProduct(string codigoDeBarras)
        {
            ...
            if (dataTableProducto.Rows.Count > 0)
            {
                ...
                if (exist == false)
                {
                    ...
                    dataGridViewDetalleDeVenta["Id", rowIndex].Value = "0";
