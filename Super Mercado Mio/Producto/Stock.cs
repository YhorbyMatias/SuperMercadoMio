...
namespace Super_Mercado_Mio.Producto
{
    public partial class Stock : Form
    {
        ...
        {
            loadDataGridViewProductos(productObject.getStock());
        }
        #endregion
        ...
        private void formatDataGridViewProductos()
        {
            ...
            dataGridViewProductos.Columns["Stock"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
